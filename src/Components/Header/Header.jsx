      ...
      <Link to="/">
        ...
        <div
          className={`w-full ${
            isPackagesPage
              ? "h-auto text-black"
              : "h-[450px] md:h-[500px] lg:h-[550px] xl:h-[600px] 2xl:h-[650px] bg-cover bg-no-repeat bg-left-top"
          }`}
          style={{
            backgroundImage: isPackagesPage
              ? "none"
        ...
        >
          ...
          <div className="pt-2 flex flex-row place-content-between items-center px-4 md:px-8 lg:px-12">
            <RightImg />
